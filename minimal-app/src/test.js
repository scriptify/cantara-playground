"use strict";
(self.webpackChunkcantara = self.webpackChunkcantara || []).push([
  [179],
  {
    7661: (M, L, j) => {
      j(8487);
      var N = j(1146),
        ...
        S = j(9722),
        x = {};
      (x.styleTagTransform = z()),
        (x.setAttributes = C()),
        (x.insert = y().bind(null, "head")),
        (x.domAPI = T()),
        (x.insertStyleElement = i()),
        I()(S.Z, x),
      ...
      const Y = function () {
        return (
          ...
          (0, O.jsxs)("div", {
            className: "app",
            children: [
              (0, O.jsx)("h1", { children: "Hello World!" }),
              (0, O.jsx)("p", { children: "Foo to the barz" }),
              (0, O.jsx)("img", { src: c.default, height: "480" }),
            ],
          })
        );
      };
      var k = j(1139),
        Q = document.getElementById("app");
      (0, k.s)(Q).render((0, O.jsx)(Y, {}));
    },
    9722: (M, L, j) => {
      j.d(L, { Z: () => g });
      var N = j(9358),
